...
\begin{document}
	...
	\draw (2) edge[brown,out=20, in=160, ->, thick] node [above] {} (3);
	\draw (3) edge[brown, out=-160, in=-20, ->, thick] node [above] {} (2);

	\draw (0) edge[brown,out=-70, in=70, ->, thick] node [above] {} (2);
	\draw (2) edge[cyan, out=110, in=-110, ->, thick] node [above] {} (0);

	\draw (1) edge[brown,out=-70, in=70, ->, thick] node [above] {} (3);
	\draw (3) edge[cyan, out=110, in=-110, ->, thick] node [above] {} (1);

    \draw (0) edge[brown,out=-35, in=125, ->, thick] node [above] {} (3);
    \draw (3) edge[cyan, out=145, in=-55, ->, thick] node [above] {} (0);

    \draw (1) edge[brown,out=-125, in=35, ->, thick] node [above] {} (2);
    \draw (2) edge[cyan, out=55, in=-145, ->, thick] node [above] {} (1);

    \draw (0) edge[cyan, out=180, in=135, ->, thick, loop] node [above] {}  (0);
    \draw (2) edge[brown,out=180, in=135, ->, thick, loop] node [above] {} (2);

    \draw (1) edge[cyan,out=0, in=45, ->, thick, loop] node [above] {} (1);
    \draw (3) edge[brown, out=0, in=45, ->, thick, loop] node [above] {} (3);
