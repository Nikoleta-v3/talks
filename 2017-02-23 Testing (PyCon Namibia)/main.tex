...
\color{yellow!79}
\Large{
$\frac{F_{10}}{F_{9}} =  1.617  $ \\
$\frac{F_{11}}{F_{10}} =  1.618  $ \\
$\frac{F_{12}}{F_{11}} =  1.617  $ \\
$\frac{F_{13}}{F_{12}} =  1.618  $ \\
$\frac{F_{14}}{F_{13}} =  1.618  $ \\
$\frac{F_{15}}{F_{14}} =  1.618  $ \\
...
\begin{center}
    \begin{tikzpicture}
        \node [align=center, text=yellow!79] {\large{Glynatsi2017, ``SOLVES THE
                                                      FIBONACCI MYSTERY"}};
...
\begin{center}
    \begin{tikzpicture}
        \node [align=center, text=yellow!79] {\large{Glynatsi2017, ``TRYING TO
        RECLAIM REPUTATION"}};
    \end{tikzpicture}
\end{center}
\end{frame}
...
\begin{center}
    \begin{tikzpicture}[scale=10]
        \node [align=center, text=yellow!79] {\tiny{USE} \\
        \Huge{92\%}};
    \end{tikzpicture}
\end{center}
\end{frame}
