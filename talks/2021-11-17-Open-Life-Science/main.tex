...
\begin{frame}
    ...
    \toprule
    Publishing method & Example & Citation & software peer-reviewed & journal publication & time efficient\\
    \midrule
    Public repo \& citation file & Citation File Format  & \checkmark & $\times$ & $\times$ & \checkmark\\
    Community peer review & rOpenSci, pyOpensci   & \checkmark & \checkmark & $\times$ & \checkmark \\
    Software paper & Journal of Computational Electronics & \checkmark & $\times$ & \checkmark & $\times$ \\
    Software meta-paper & JOSS, JOSE   & \checkmark & \checkmark & \checkmark  &  \checkmark\\
    \bottomrule
        \end{tabular}}
    \end{center}}

    \centering
    \tiny{Lucy Whalley in SeptembRSE: \url{https://www.youtube.com/watch?v=l1B2kqoxqAo&t=1824s}}
\end{frame}

\begin{frame}
    \centering
    \Large{\textbf{\textcolor{orange}{Citing} open research code}}
\end{frame}
