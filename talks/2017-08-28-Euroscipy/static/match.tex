...
\begin{tikzpicture}[scale=2]
    ...
    \node[thick] (0) at (-1, 0) [state] {\textcolor{cyan}{SneakyTitForTat}};
    \node[thick] (1) at (-1, -1) [state] {\textcolor{brown}{Grudger}};
