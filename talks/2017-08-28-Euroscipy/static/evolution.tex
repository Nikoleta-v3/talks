...
\begin{document}
    ...
    \node[circle, fill=cyan, thick, draw=red!70, thick] (3) at (1.5, -2) [state]  {};
    ...
    \draw (3) edge[out=-90, in=-90, ->, ultra thick, red!80, dotted, looseness=0.5] node [below] {\footnotesize{\textit{$selection \setminus replacement$}}} (8);
