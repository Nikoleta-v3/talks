...
\begin{document}
    ...
    \node[circle, fill=red, thick] (1) at (-2, 0) [state]  {};
    \node[circle, fill=red, thick] (2) at (-1.5, -2) [state] {};
    ...
    \node[circle, fill=red, thick] (6) at (5, 0) [state]  {};
    \node[circle, fill=red, thick] (7) at (5.5, -2) [state] {};
    \node[circle, fill=red, thick] (8) at (8.5, -2) [state]  {};
    ...
    \node[circle, fill=red, thick] (10) at (13, 1.5) [state]   {};
    \node[circle, fill=red, thick] (11) at (11, 0) [state]  {};
    \node[circle, fill=red, thick] (12) at (11.5, -2) [state] {};
    \node[circle, fill=red, thick] (13) at (14.5, -2) [state]  {};
    \node[circle, fill=red, thick] (14) at (15, 0) [state]   {};
