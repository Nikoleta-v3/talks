\documentclass{standalone}
    ...
    \begin{tikzpicture}
        \draw[dashed, solarizedRed] (0.5, 1.25) -- (0.5, 0);
        \draw[dashed, solarizedRed] (0.1, 0.5) -- (1.25, 0.5);
        ...
        \node[circle, fill=solarizedRed, inner sep=0pt,minimum size=2pt] at (0.5, 0.5) {};
