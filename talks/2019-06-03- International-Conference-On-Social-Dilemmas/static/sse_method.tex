\documentclass{standalone}
    ...
    \begin{tikzpicture}
        ...
        \node (p) at (2, 0.5) {\Large{$\mathbf{p = (p_1, p_2, p_3, p_4)}$}};
        \node (zd) at (14, 0.5) {\Large{\textbf{Extort 2} $\mathbf{= (8/9, 1/2, 1/3, 0)}$}};

        \node (measure) at (7, -2)  {\includegraphics[width=\textwidth]{static/sse_error_palette.png}};

        \draw (p) edge[out=0, in=105, ->, thick] node [above] {} (measure);
