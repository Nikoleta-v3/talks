...
\begin{document}
    ...
    \node[circle, ultra thick] (0) at (3.5, 1.5) [state] {\LARGE \textbf{\textcolor{orange}4}};
    \node[circle, ultra thick] (0) at (3.5, -0.5) [state] {\LARGE \textbf{\textcolor{orange}0}};
    \node[circle, ultra thick] (0) at (0.5, 0.5) [state] {\LARGE \textbf{\textcolor{cyan}4}};
    ...
    \node[circle, ultra thick] (0) at (7.5, -0.5) [state] {\LARGE \textbf{\textcolor{orange}2}};
    \node[circle, ultra thick] (0) at (4.5, 0.5) [state] {\LARGE \textbf{\textcolor{cyan}0}};
    \node[circle, ultra thick] (0) at (4.5, -1.5) [state] {\LARGE\textbf{ \textcolor{cyan}2}};
