...
%%%%%%Title%%%%%%%%
\title{A trip to earth science with Python as a companion}
\author{@NikoletaGlyn}
\date{}
\institute[]
{
\begin{center}
    %\includegraphics[width=.15\textwidth]{static/pyconuk.png}
    \includegraphics[width=.20\textwidth]{static/PyDiff.png}
\end{center}
}
...
\begin{frame}
    ...
    \textcolor{orange}{
    \begin{todolist}
        \item[\done] several things have been invented by our ancestors;
        \item[\done] mathematics make use of our alphabet;
    \end{todolist}
    }
\end{frame}
...
>>> report = earthquakes.get_report('hour', 'all')
    \end{minted}
\end{frame}
