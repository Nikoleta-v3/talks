...
\begin{frame}{Winning Ratio}
	\begin{center}
		\includegraphics[width=0.55\linewidth]{static/winning_ratio.pdf}
	\end{center}
\end{frame}
\begin{frame}{Normalised Average Score}
	\begin{center}
		\includegraphics[width=0.55\linewidth]{static/normalized_average_score.pdf}
	\end{center}
\end{frame}
\begin{frame}{Normalised Median Rank}
	\begin{center}
		\includegraphics[width=1\linewidth]{static/median-ranking.pdf}
	\end{center}
\end{frame}
...
\begin{frame}{Conclusions and Futher Research}
    ...
    \item Further Research
        \begin{itemize} [label={--}]
        \item Generate more data
        \item Run genetic algorithm for more generations
        \item Logistic regression \& random forest analysis
        \item Evolutionary and Probabilistic endings tournaments
    \end{itemize}
    \end{itemize}
\end{frame}
